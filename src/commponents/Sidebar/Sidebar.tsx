        ...
        <BarContainer isOpen={false} isMobileMode={isScreenMd} title="Menu">
            ...
            <List className="mt-5 mb-7" title="Lists">
                <ListItem
                    messageCount={3}
                    primary="Personal"
                    icon={<DefaultIcon color="#ff6b6b" />}
                />
                <ListItem
                    messageCount={6}
                    primary="Work"
                    icon={<DefaultIcon color="#67d9e8" />}
                />
                <ListItem
                    messageCount={3}
                    primary="List 1"
                    icon={<DefaultIcon color="#ffd43b" />}
                />
                <ListItem primary="Add new list" icon={<AiOutlinePlus />} />
            </List>
            <Divider />
            ...
            <BarFooter>
                <Button className="text-sm" isLink to="/settings" variant="text" icon={<GiSettingsKnobs />}>
                    Settings
                </Button>
                <Button className="text-sm mt-1" variant="text" icon={<ImExit />}>
                    Sign out
                </Button>
            </BarFooter>
        </BarContainer>
